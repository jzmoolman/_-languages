...
HD_PWD='/home/jzmoolman/src/_-languages/verilog/test-cases/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter0.tcl
