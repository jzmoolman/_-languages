...
HD_PWD='/home/jzmoolman/src/_languages/Getting started with FPGAs/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Toggle_Project2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_Toggle_Project2.tcl
