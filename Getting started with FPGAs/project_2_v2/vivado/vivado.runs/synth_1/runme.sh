...
HD_PWD='/home/jzmoolman/src/_-languages/Getting started with FPGAs/project_2_v2/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_gate_project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_gate_project.tcl
